...
export default function AssessmentExecutionPage() {
  ...
  if (error && !session) {
    return (
      <div className="max-w-md mx-auto mt-16 p-6 rounded-xl bg-slate-900 border border-slate-800 text-center">
  ...
  if (completedResult) {
    ...
    return (
      <div className="max-w-xl mx-auto mt-12 p-8 rounded-2xl bg-slate-900 border border-slate-800 text-center shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-4 bg-slate-950 p-4 rounded-xl border border-slate-800 mb-6">
          <div>
          ...
          <div>
            <div className="text-xs text-slate-500">Passing Criteria</div>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl text-white font-medium text-sm transition-all"
          >
            Return to Dashboard
          </button>
        </div>
